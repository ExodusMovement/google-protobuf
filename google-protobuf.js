...
$jscomp.array.from = function(a, b, c) {
  ...
  if ("function" == typeof a.next)
    for (; !(e = a.next()).done; ) d.push(b.call(c, e.value));
  else for (var e = a.length, f = 0; f < e; f++) d.push(b.call(c, a[f]));
  return d;
};
...
$jscomp.string.fromCodePoint = function(a) {
  for (var b = "", c = 0; c < arguments.length; c++) {
    ...
    65535 >= d
      ...
      : ((d -= 65536),
        (b += String.fromCharCode(((d >>> 10) & 1023) | 55296)),
  ...
  for (
    ...
    do {
      ...
      var c = 0 == m[1].length ? 0 : parseInt(m[1], 10),
        ...
        c =
          goog.string.compareElements_(c, q) ||
          goog.string.compareElements_(0 == m[2].length, 0 == n[2].length) ||
...
jspb.Map.deserializeBinary = function(a, b, c, d, e, f) {
  for (var g = void 0; b.nextField() && !b.isEndGroup(); ) {
    ...
    1 == h
      ...
      : 2 == h &&
        (a.valueCtor_
          ? (goog.asserts.assert(e), (g = new a.valueCtor_()), d.call(b, g, e))
          : (g = d.call(b)));
  }
...
jspb.Message.initPivotAndExtensionObject_ = function(a, b) {
  if (a.array.length) {
    ...
    if (
      d &&
      "object" == typeof d &&
      !jspb.Message.isArray_(d) &&
      !(jspb.Message.SUPPORTS_UINT8ARRAY_ && d instanceof Uint8Array)
    ) {
  ...
  -1 < b
    ? ((a.pivot_ = b), (a.extensionObject_ = null))
...
jspb.Message.getField = function(a, b) {
  ...
  if (a.extensionObject_)
    return (
      ...
      d === jspb.Message.EMPTY_LIST_SENTINEL_ ? (a.extensionObject_[b] = []) : d
    );
};
...
jspb.Message.compareFields = function(a, b) {
  ...
  if (a.constructor === Array) {
    for (
      var d = void 0, e = void 0, f = Math.max(a.length, b.length), c = 0;
      c < f;
      c++
    ) {
      var g = a[c],
    ...
    for (var c = Array(a.length), d = 0; d < a.length; d++)
      (b = a[d]),
        null != b &&
          (c[d] =
            "object" == typeof b
              ? jspb.Message.clone_(goog.asserts.assert(b))
              : b);
    return c;
  }
  if (jspb.Message.SUPPORTS_UINT8ARRAY_ && a instanceof Uint8Array)
...
jspb.utils.splitFloat32 = function(a) {
  ...
  0 === a
    ...
    : a < jspb.BinaryConstants.FLOAT32_MIN
    ? ((a = Math.round(a / Math.pow(2, -149))),
      (jspb.utils.split64High = 0),
      (jspb.utils.split64Low = ((b << 31) | a) >>> 0))
    : ((c = Math.floor(Math.log(a) / Math.LN2)),
      (a *= Math.pow(2, -c)),
...
jspb.utils.joinFloat64 = function(a, b) {
  ...
  return 2047 == d
    ...
    : 0 == d
    ? c * Math.pow(2, -1074) * e
    : c * Math.pow(2, d - 1075) * (e + jspb.BinaryConstants.TWO_TO_52);
};
...
jspb.utils.hash64ToDecimalString = function(a, b) {
  ...
  return b
    ? jspb.utils.joinSignedDecimalString(c, d)
...
jspb.BinaryWriter.prototype.writeInt32String = function(a, b) {
  if (null != b) {
    var c = parseInt(b, 10);
    goog.asserts.assert(
      c >= -jspb.BinaryConstants.TWO_TO_31 && c < jspb.BinaryConstants.TWO_TO_31
    );
...
jspb.BinaryDecoder.prototype.readSplitVarint64_ = function() {
  for (var a, b = 0, c, d = 0; 4 > d; d++)
    if (
      ((a = this.bytes_[this.cursor_++]), (b |= (a & 127) << (7 * d)), 128 > a)
    ) {
      this.tempLow_ = b >>> 0;
      this.tempHigh_ = 0;
      return;
