...
// symbol export removed: (('proto.google.protobuf.Enum', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.EnumValue', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.Field', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.Field.Cardinality', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.Field.Kind', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.Option', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.Syntax', null, localProtoScope);
// symbol export removed: (('proto.google.protobuf.Type', null, localProtoScope);
/**
    ...
    var f,
      obj = {
        ...
        fieldsList: jspb.Message.toObjectList(
          msg.getFieldsList(),
          proto.google.protobuf.Field.toObject,
          includeInstance
        ),
        oneofsList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f,
        optionsList: jspb.Message.toObjectList(
          msg.getOptionsList(),
          proto.google.protobuf.Option.toObject,
          includeInstance
        ),
        sourceContext:
          (f = msg.getSourceContext()) && google_protobuf_source_context_pb.SourceContext.toObject(includeInstance, f),
...
proto.google.protobuf.Type.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, proto.google.protobuf.Field.serializeBinaryToWriter);
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(4, f, proto.google.protobuf.Option.serializeBinaryToWriter);
  }
  f = message.getSourceContext();
  if (f != null) {
    writer.writeMessage(5, f, google_protobuf_source_context_pb.SourceContext.serializeBinaryToWriter);
  }
  f = message.getSyntax();
  if (f !== 0.0) {
...
proto.google.protobuf.Type.prototype.getFieldsList = function () {
  return /** @type{!Array<!proto.google.protobuf.Field>} */ (jspb.Message.getRepeatedWrapperField(
    this,
...
proto.google.protobuf.Type.prototype.getOptionsList = function () {
  return /** @type{!Array<!proto.google.protobuf.Option>} */ (jspb.Message.getRepeatedWrapperField(
    this,
...
proto.google.protobuf.Type.prototype.getSourceContext = function () {
  return /** @type{?proto.google.protobuf.SourceContext} */ (jspb.Message.getWrapperField(
    this,
...
proto.google.protobuf.Field.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getOptionsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(9, f, proto.google.protobuf.Option.serializeBinaryToWriter);
  }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.google.protobuf.Enum.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        name: jspb.Message.getFieldWithDefault(msg, 1, ''),
        enumvalueList: jspb.Message.toObjectList(
          msg.getEnumvalueList(),
          proto.google.protobuf.EnumValue.toObject,
          includeInstance
        ),
        optionsList: jspb.Message.toObjectList(
          msg.getOptionsList(),
...
proto.google.protobuf.Enum.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, proto.google.protobuf.EnumValue.serializeBinaryToWriter);
  }
  f = message.getOptionsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, proto.google.protobuf.Option.serializeBinaryToWriter);
  }
  f = message.getSourceContext();
  if (f != null) {
    writer.writeMessage(4, f, google_protobuf_source_context_pb.SourceContext.serializeBinaryToWriter);
  }
  f = message.getSyntax();
  if (f !== 0.0) {
...
proto.google.protobuf.Enum.prototype.getEnumvalueList = function () {
  return /** @type{!Array<!proto.google.protobuf.EnumValue>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.google.protobuf.EnumValue,
    2
  ));
};
